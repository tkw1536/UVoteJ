 ...
 * @method PermissionNode
 * @param {object} [source_object] - Optional JSON source for the permissionNode.
 */
 ...
 * @param {object} source_object - JSON source for the permissionNode.
 */
...
/**
 * Returns the JSON source of this object.
 */
...
PermissionNode.prototype.matchesRule = function(user_data, rule){
    ...
    var query = rule["value"];

    //in case we have an exception, this is our result
    var result = rule["exceptionHandling"];
...
/*
    ...
    {
        "negate": true || false,
        "fieldName": <NameOfFieldToCheck>,
        "fieldRelation": "equals" || "equalsNoCase" || "contains" || "startsWith" || "endsWith" || "matches" || "biggerThen" || "smallerThen",
        "value": <Value|RegEx>,
        "nextRelation": "and" || "or",
